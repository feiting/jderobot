...
En esta sección ofrecemos una versión resumida de lo que proporciona cada driver. Para más información consulta la sección de configuración.
   \begin{enumerate}
      ...
      \item \textit{graphics\_xforms}: permite obtener soporte para cargar interfaces gráficos creados con xforms en la plataforma.
      \item \textit{graphics\_gtk}: permite obtener soporte para cargar interfaces gráficos creados con gtk en la plataforma.
   \end{enumerate}
