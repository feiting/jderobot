...
FD_papitogui *create_form_papitogui(void)
{
  FL_OBJECT *obj;
  FD_papitogui *fdui = (FD_papitogui *) fl_calloc(1, sizeof(*fdui));

  fdui->papitogui = fl_bgn_form(FL_NO_BOX, 160, 70);
